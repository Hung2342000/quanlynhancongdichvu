...
<!--					<a target="_blank" href="--><?php //=APP_WEB_URL?><!--/generateInstanceKey.php?id=--><?php //=$baseService->getInstanceId()?><!--">-->
<!--						--><?php //=APP_WEB_URL?><!--/generateInstanceKey.php?id=--><?php //=$baseService->getInstanceId()?>
<!--					</a>-->
<!---->
<!--					<br/><b>Step 2:</b><br/>-->
